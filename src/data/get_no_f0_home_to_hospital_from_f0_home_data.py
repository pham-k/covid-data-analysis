...
no_f0_home_to_hospital = df.groupby('date_report')[['no_f0_home_to_hospital']].apply(sum)
no_f0_home_to_hospital['no_f0_home_to_hospital_rollmean7d'] = (
    no_f0_home_to_hospital.no_f0_home_to_hospital.rolling(7).mean()
)
...
# %% Export
no_f0_home_to_hospital.to_csv(
    path.processed / 'from-f0-home-data'/ 'no-f0-home-to-hospital.csv',
    sep=','
)
